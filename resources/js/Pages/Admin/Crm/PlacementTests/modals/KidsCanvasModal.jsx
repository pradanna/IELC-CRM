...
export default function KidsCanvasModal({ show, onClose, form, onSubmit, editingQuestion, targetGroupId }) {
        ...
        <Modal show={show} onClose={onClose} maxWidth="full">
            <div className="p-8">
                <div className="flex items-center justify-between gap-4 mb-6 pb-4 border-b border-slate-100">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-slate-400 mt-1">Rancang area kanvas interaktif, letak target drag & drop, dan gambar objek</p>
                        </div>
                    </div>
                ...
                <form onSubmit={onSubmit} className="space-y-6">
                    ...
                    <div>
                        <InputLabel value="Instruksi Soal untuk Anak" className="font-bold" />
                        <TextArea
                            required
                            className="mt-1.5"
                            rows={2}
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        {/* Audio Guide */}
                        <div>
                            <InputLabel value="Audio Panduan Suara (Opsional)" className="font-bold" />
                            <FileInput
                                accept="audio/*,video/*"
                    ...
                    <div className="pt-2">
                        <InputLabel value="Interactive Canvas Studio Builder" className="font-black text-slate-800 mb-2" />
                    ...
                    <div className="flex items-center justify-between pt-4 border-t border-slate-100">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <PrimaryButton type="submit" disabled={form.processing} className="bg-amber-500 hover:bg-amber-600 focus:ring-amber-500 text-white">
                                {form.processing ? 'Menyimpan...' : editingQuestion ? 'Update Canvas Soal' : 'Simpan Canvas Soal'}
                            </PrimaryButton>
                        </div>
                    </div>
                </form>
