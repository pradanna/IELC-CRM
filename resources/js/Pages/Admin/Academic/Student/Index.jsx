...
export default function Index({
    ...
    const [initialTransferClassId, setInitialTransferClassId] = useState(null);

    const urlParams = new URLSearchParams(window.location.search);
    const [activeMainTab, setActiveMainTab] = useState(
        urlParams.get("mainTab") || "list",
    );
    ...
    const handleDashboardFilterChange = (newFilters) => {
        ...
        router.get("/admin/academic/students", params, {
            preserveState: false,
            preserveScroll: true,
        });
    };
    ...
    const buildListExportUrl = (format) => {
        ...
        const activeParams = Object.fromEntries(
            Object.entries({ ...filters, search }).filter(
    ...
    const openTransferModal = (student, classId = null) => {
        setSelectedStudent(student);
        setInitialTransferClassId(classId);
        setIsTransferModalOpen(true);
    };

    const closeTransferModal = () => {
        setSelectedStudent(null);
        setInitialTransferClassId(null);
        ...
        return (
            ...
            >
                ...
                {isSorted ? (
                    ...
                    <ArrowUpDown
                        size={12}
                        className="text-slate-300 group-hover:text-slate-455"
                    />
                )}
            </button>
        );
        ...
        <AdminLayout>
                        ...
                        <div className="bg-white rounded-2xl p-3 sm:p-4 shadow-sm border border-slate-100 relative z-20">
                            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-3 lg:grid-cols-5 xl:grid-cols-9 gap-2 items-center">
                                <form
                                    ...
                                    className="relative group col-span-2 sm:col-span-1 md:col-span-1 xl:col-span-1"
                                >
                                    <TextInput
                                        value={search}
                                        onChange={(e) =>
                                        ...
                                        className="w-full !rounded-xl !pl-8 !pr-2 !py-2 border-slate-200 focus:border-red-500 transition-all shadow-xs text-[11px] font-medium"
                                    />
                                ...
                                <div>
                                    <PremiumSelect
                                        ...
                                        onChange={handleFilterLoyaltyTier}
                                        icon={Award}
                                ...
                                <div>
                                    <PremiumSelect
                                        options={[
                                            {
                                                value: "",
                                                label: "Semua Masa Aktif",
                                            },
                                            {
                                                value: "not_expired",
                                                label: "Belum Habis (Aktif)",
                                            },
                                            {
                                                value: "expiring_soon",
                                                label: "Hampir Habis (≤ 21 Hari)",
                                            },
                                            {
                                                value: "expired",
                                                label: "Sudah Habis",
                        ...
                        <div className="bg-white rounded-3xl border border-slate-100 shadow-sm overflow-hidden">
                                ...
                                <table className="w-full text-left border-collapse">
                                    <thead>
                                        <tr className="bg-slate-50/50">
                                            ...
                                            <th className="px-8 py-5 text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] border-b border-slate-100 uppercase">
                                                Contact & Branch
                                            </th>
                                            <th className="px-8 py-5 text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] border-b border-slate-100 uppercase">
                                                Active Classes
                                                                        ...
                                                                        <div className="space-y-1.5">
                                                                            ...
                                                                            <div className="flex items-center flex-wrap gap-1.5 pt-0.5">
                                                                                <span className="text-[9px] font-black text-slate-500 uppercase tracking-wider bg-slate-100 px-2 py-0.5 rounded-lg border border-slate-200/50 flex items-center gap-1 shadow-sm">
                                                                                    ...
                                                                                    />
                                                                                    {student.rejoin_count ||
                                                                                        0}{" "}
                                                                                    Paket
                                                                                </span>
                                                                                {student.loyalty_tier && (
                                                                                    <span
                                                                                        className={`text-[9px] font-black uppercase tracking-wider px-2 py-0.5 rounded-lg border flex items-center gap-1 shadow-sm ${
                                                                                            student.loyalty_tier.toLowerCase() ===
                                                                                            "silver"
                                                                                ...
                                                                                (
                                                                                    ...
                                                                                    return (
                                                                                        ...
                                                                                        >
                                                                                            ...
                                                                                            {warning && (
                                                                                                <span
                                                                                                    className={`px-2 py-0.5 text-[8px] font-black uppercase tracking-wider rounded border ${warning.class} w-fit`}
                                                                                                >
                                                                                                    {
                                                                                                        warning.text
                                                                                                    }
                                                                    ...
                                                                    <div className="space-y-1.5">
                                                                        ...
                                                                        student
                                                                            ...
                                                                            <div className="flex flex-col gap-1">
                                                                                ...
                                                                                <span
                                                                                    className="text-[9px] font-bold text-slate-400 truncate max-w-[160px]"
                                                                                    title={
                                                                                        student
                                                                                            .progress_reports[0]
                                                                                            .title
                            ...
                            <div className="px-8 py-6 bg-slate-50/50 border-t border-slate-100 flex flex-col sm:flex-row justify-between items-center gap-4">
                                <span className="text-xs font-bold text-slate-450 uppercase tracking-widest">
                                    Showing {students.data?.length || 0} of{" "}
                                    {students.meta?.total || 0} Registered
                                    Students
                                </span>
                                <Pagination
                                    links={
                                        students.meta?.links ||
                                        (Array.isArray(students.links)
                                            ? students.links
                                            : [])
                                    }
                                />
            ...
            {selectedStudent && (
                <StudentDetailModal
                    ...
                    onTransferClass={(student, classId) => {
                        closeDetailModal();
                        openTransferModal(student, classId);
                    }}
                />
            )}
            ...
            {selectedStudent && (
                <TransferClassModal
                    ...
                    initialFromClassId={initialTransferClassId}
                />
            )}
