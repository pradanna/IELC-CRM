                                    ...
                                    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white p-6 rounded-3xl shadow-md relative overflow-hidden">
                                        <div className="flex items-center gap-4 relative z-10">
                                            {(() => {
                                                 ...
                                                 // Canvas Browser Compressor (compress to WebP < 200KB before uploading)
                                                 ...
                                                 const handlePhotoChange = async (e) => {
                                                     ...
                                                     try {
                                                         // 1. Compress image in browser (frontend)
                                                 ...
                                                 return (
                                                     <div className="relative group shrink-0">
                                                         ...
                                                         {/* Main Avatar Container (Click to View Photo) */}
                                                         <div
                                                             onClick={() => {
                                                                 if (currentPhoto) {
                                                         ...
                                                         {/* Edit Pencil Badge Button (Click to Upload/Change Photo) */}
                                                         <button
                                                             type="button"
                                                             onClick={(e) => {
                                                                 e.stopPropagation();
                                                ...
                                                {(() => {
                                                    ...
                                                    const handleSaveNotes = async () => {
                                                        ...
                                                        try {
                                                            ...
                                                            student.notes = notesText; // update local ref
