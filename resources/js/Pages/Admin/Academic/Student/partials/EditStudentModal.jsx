    ...
    useEffect(() => {
        if (show && student) {
            setData({
                ...
                rejoin_count: student.rejoin_count ?? 0,
                notes: student.notes || "",
            });
            clearErrors();
        }
                        ...
                        >
                            <Dialog.Panel className="relative transform overflow-hidden rounded-[32px] bg-white text-left shadow-2xl transition-all sm:my-8 sm:w-full sm:max-w-lg border border-slate-100">
                                ...
                                >
                                    ...
                                    {/* Grid for Start Join & Rejoin Count */}
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                        {/* Start Join Date */}
                                        <div className="space-y-2">
                                            <InputLabel
                                                htmlFor="start_join"
                                                value="Start Join Date"
                                            />
                                            ...
                                            <InputError
                                                message={errors.start_join}
                                            />
                                        </div>

                                        {/* Rejoin / Completed Packages Count */}
                                        <div className="space-y-2">
                                            <InputLabel
                                                htmlFor="rejoin_count"
                                                value="Total Paket Selesai"
                                            />
                                            <div className="relative">
                                                <TextInput
                                                    id="rejoin_count"
