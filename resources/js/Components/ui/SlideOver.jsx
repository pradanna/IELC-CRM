...
export default function SlideOver({ show, onClose, title, children }) {
    return (
        <Transition.Root show={show} as={Fragment}>
            <Dialog as="div" className="relative z-[500]" onClose={() => {}}>
                <Transition.Child
                    ...
                    leaveTo="opacity-0"
                >
                    <div className="fixed inset-0 bg-black/5 backdrop-blur-[1px] transition-opacity" />
                </Transition.Child>
                            ...
                            >
                                <Dialog.Panel className="pointer-events-auto w-screen max-w-md md:max-w-xl">
                                    <div className="flex h-full flex-col overflow-y-scroll bg-white shadow-xl">
                                        <div className="px-4 py-6 sm:px-6 bg-gray-50/50 border-b border-gray-100">
