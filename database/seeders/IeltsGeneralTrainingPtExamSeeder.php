...
class IeltsGeneralTrainingPtExamSeeder extends Seeder
{
    /**
     * Run the database seeds.
     *
     * Seeder ini membuat paket tes penempatan "IELTS General Training Placement Test"
     * berdasarkan materi resmi dari portal Exam Prep IELC (Google Sites):
     * - Listening (4 Sections, 40 soal)
     * - Reading (3 Sections/Passages, 40 soal)
     * - Writing Task 1 (Formal Letter 150 kata) & Task 2 (Discursive Essay 250 kata)
     * - Speaking (Konsultasi wawancara live)
     */
    public function run(): void
    {
        // 1. Sync IELTS media assets (Audio, PDF booklet, etc.) ke storage & public
        ...
        if (File::exists($ieltsSource)) {
            ...
            $this->command->info('✅ IELTS GT assets synced to local storage & public.');
        }

        $jsonPath = __DIR__ . '/data/placement_test_ielts_general_training.json';
        ...
        $this->command->info("✅ Seeder IELTS General Training Placement Test berhasil dijalankan.");
    }
}
